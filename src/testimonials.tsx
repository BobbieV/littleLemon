        ...
        <header id="testimonials">
          ...
          <section className="testimonialContainersWrapper">
            <section className="testimonialContainer testimonial1">
              <img className="testimonialUserImage" alt="a round profile image icon with a blonde woman and a small white dog" src="https://github.com/BobbieV/littleLemon/blob/88e414dfd6b3636026a90dc465f15aaafc032289/src/assets/images/'Joan'%20Female%20Profile%20Pic%2075%20x%2075px.png?raw=true"></img>
            ...
            <img className="testimonialUserImage" alt="a round profile image icon with a brunette woman in front of a greenery background" src="https://github.com/BobbieV/littleLemon/blob/88e414dfd6b3636026a90dc465f15aaafc032289/src/assets/images/'Diane'%20Female%20Profile%20Pic%2075%20x%2075px.png?raw=true"></img>
              <hgroup className="h2TestimonialText">
            ...
            <section className="testimonialContainer">
            <img className="testimonialUserImage" alt="a round profile image icon with a man and a small white dog" src="https://github.com/BobbieV/littleLemon/blob/88e414dfd6b3636026a90dc465f15aaafc032289/src/assets/images/'David'%20Male%20Profile%20Pic%2075%20x%2075px.png?raw=true"></img>
              <hgroup className="h2TestimonialText">
            ...
            <section className="testimonialContainer">
            <img className="testimonialUserImage" alt="a round profile image icon with a brunette woman wearing a grey hat" src="https://github.com/BobbieV/littleLemon/blob/88e414dfd6b3636026a90dc465f15aaafc032289/src/assets/images/'Jenna'%20Female%20Profile%20Pic%2075%20x%2075px.png?raw=true"></img>
              <hgroup className="h2TestimonialText">
