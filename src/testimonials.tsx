        ...
        <header id="testimonialsWrapper">
          ...
          <section className="testimonialContainersWrapper">
            ...
            <img className="testimonialUserImage testimonialUserImage2 testimonialUserImageDiane" src="https://github.com/BobbieV/littleLemon/blob/88e414dfd6b3636026a90dc465f15aaafc032289/src/assets/images/'Diane'%20Female%20Profile%20Pic%2075%20x%2075px.png?raw=true"></img>
              <hgroup className="h2TestimonialText">
                <h2 className="rating rating2">10/10</h2>
                <h2 className="name name1">Diane</h2>
              </hgroup>
              <p className="userFeedback userFeedback2">Everything was perfect! The food was absolutely delicious, the service was top-notch, and the atmosphere was wonderful. Highly recommend this restaurant.</p>
            </section>
            <section className="testimonialContainer testimonial3">
            <img className="testimonialUserImage testimonialUserImage3 testimonialUserImageDavid" src="https://github.com/BobbieV/littleLemon/blob/88e414dfd6b3636026a90dc465f15aaafc032289/src/assets/images/'David'%20Male%20Profile%20Pic%2075%20x%2075px.png?raw=true"></img>
              <hgroup className="h2TestimonialText">
                <h2 className="rating rating3">9/10</h2>
                <h2 className="name name1">David</h2>
              </hgroup>
              <p className="userFeedback userFeedback3">The food was great, but the service was a bit slow. The atmosphere was nice, but a little noisy. Still, a solid choice for a night out.</p>
            </section>
            <section className="testimonialContainer testimonial4">
            <img className="testimonialUserImage testimonialUserImage4 testimonialUserImageJenna" src="https://github.com/BobbieV/littleLemon/blob/88e414dfd6b3636026a90dc465f15aaafc032289/src/assets/images/'Jenna'%20Female%20Profile%20Pic%2075%20x%2075px.png?raw=true"></img>
              <hgroup className="h2TestimonialText">
                <h2 className="rating rating4">8/10</h2>
