    ...
    <>
        <header id="#specials" style={{/*width: 1440, height: 800,*/ background: '#EDEFEE'}}>
          <section className="topWrapper">
            <h1 className="h1Specials" style={{/*width: 465, height: 92,*/ color: '#333333', fontSize: 32, fontFamily: 'Markazi Text', fontWeight: '500', wordWrap: 'break-word'}}>This week's specials!</h1>
