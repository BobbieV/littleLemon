    ...
    <>
        <header id="#specials" style={{/*width: 1440, height: 800,*/ background: '#EDEFEE'}}>
          <section className="topWrapper">
            ...
            <button className="buttonOM" style={{/*width: 200, height: 75,*/ textAlign: 'center', color: '#333333', /*fontSize: 28,*/ fontFamily: 'Markazi Text', fontWeight: '500', wordWrap: 'break-word'}} onClick={() => alert('This feature is coming soon!')}>Online Menu</button>
            </section>
